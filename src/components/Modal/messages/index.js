...
export default {
  ...
  areYouSureCancel: {
    id: `${scope}.areYouSureCancel`,
    defaultMessage: 'Are you sure you want to cancel your',
  },
  thisCannotUndone: {
    id: `${scope}.thisCannotUndone`,
    defaultMessage: 'This cannot be undone \& you may lose your slot & won\'t get it back',
  },
  keepAppointment: {
  ...
  currentAppointment: {
    id: `${scope}.currentAppointment`,
    defaultMessage: 'Current appointment',
  },
  newAppointment: {
  ...
  areSureChangeAppoint: {
    ...
    defaultMessage: 'Are you sure you want to change your appointment?',
  },
  current: {
    id: `${scope}.current`,
  ...
  meetingWith: {
    id: `${scope}.meetingWith`,
    defaultMessage: 'meeting with',
  },
  scheduleScreening: {
    id: `${scope}.scheduleScreening`,
    defaultMessage: 'Schedule (Screening)',
  },
  subsidyProgress: {
    id: `${scope}.subsidyProgress`,
    defaultMessage: 'Subsidy progress',
  },
  request: {
    id: `${scope}.request`,
  ...
  subsidyNotes: {
    id: `${scope}.subsidyNotes`,
    defaultMessage: 'Subsidy notes',
  },
  schoolInformation: {
    id: `${scope}.schoolInformation`,
  ...
  subsidyDetails: {
    id: `${scope}.subsidyDetails`,
    defaultMessage: 'Subsidy details',
  },
  numberApprovedSessions: {
