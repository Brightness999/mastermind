...
export const getDependent = 'users/get_dependent'
...
export const getProviders = 'admin/get_providers'
...
export const getTrackedActions = 'admin/get_tracked_actions'
export const getDataForReport = 'admin/get_data_for_report'
export const getSubsidizedSessions = 'admin/get_subsidized_sessions'
export const getNotes = 'admin/get_notes'
export const getInvoicesForReport = 'admin/get_invoices_for_report'
...
export const getLastConsulation = 'schools/get_last_consultation'
...
export const updateApprovedRequest = 'schools/update_approved_request'
...
export const declineDependent = 'providers/decline_dependent'
export const acceptDependent = 'providers/accept_dependent'
...
export const appealDependent = 'clients/appeal_dependent'
