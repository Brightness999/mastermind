 ...
 */
export const scope = 'routes.Createaccount';
...
export default ({
  ...
  moreCharacters: {
    id: `${scope}.moreCharacters`,
    defaultMessage: '8 or more characters',
  },
  beUncommon: {
    id: `${scope}.beUncommon`,
    defaultMessage: 'be uncommon',
  },
  continue: {
    id: `${scope}.continue`,
  ...
  servicesRequired: {
    ...
    defaultMessage: 'Services required',
  },
  subsidyRequest: {
    id: `${scope}.subsidyRequest`,
  ...
  technicalReferralContact: {
    id: `${scope}.technicalReferralContact`,
    defaultMessage: 'Technical Referral Contact',
  },
  addContact: {
    id: `${scope}.addContact`,
  ...
  inSchoolHours: {
    id: `${scope}.inSchoolHours`,
    defaultMessage: 'In-school session hours',
  },
  afterSchoolHours: {
    id: `${scope}.afterSchoolHours`,
    defaultMessage: 'After-school session hours',
  },
  adminDetails: {
    id: `${scope}.adminDetails`,
    defaultMessage: 'Admin details',
  },
  name: {
    id: `${scope}.name`,
    defaultMessage: 'Name',
