...
class CancelledConsultationRequest extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      consultationList: [],
  ...
  render() {
    const { pageNumber, pageSize, searchConsultantName, searchDependentName, selectedGrades, selectedSchools, selectedServices, totalSize, consultationList, skillSet, loading, csvData, selectedConsultation, visibleDrawer } = this.state;
...
export default compose(connect(mapStateToProps))(CancelledConsultationRequest);